...
<div class="container col-xxl-8 px-4 pt-3">
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="col-10 col-sm-8 col-lg-6">
            <img src="assets/img/carousel1.jpg" data-aos="zoom-in-up" class="d-block mx-lg-auto img-fluid" width="700"
                height="500" loading="lazy">
        </div>
        <div class="col-lg-6">
            <h1 class="display-5 fw-bold lh-1 mb-3" data-aos="fade-up" data-aos-duration="500">Welcome to Edukate.</h1>
