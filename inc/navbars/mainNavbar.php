...
<nav class="navbar navbar-light shadow navbar-expand-lg fixed-top bg-white" style="height: 70px;" id="myNavbar">
    <div class="container-fluid">
    <a class="navbar-brand bg text-center" href="<?php echo ROOT_URL;?>" style="font-size: 30px; font-weight: 700;">Edukate</a>
    ...
    <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav mx-auto">
            <?php if($user === 'admin' || $user === 'staff'):?>
            <li class="nav-item"><a class="nav-link hvr-underline-from-center" href="<?php echo ROOT_URL;?>dashboard.php">Dashboard</a></li>
            <?php endif; ?>
            <?php if($user === 'student'):?>
            <li class="nav-item"><a class="nav-link hvr-underline-from-center" href="<?php echo ROOT_URL;?>home.php">Home</a></li>
            <li class="nav-item"><a class="nav-link hvr-underline-from-center" href="<?php echo ROOT_URL;?>dashboard.php">Account</a></li>
            <?php endif; ?>
            <?php if($user === 'admin'):?>
