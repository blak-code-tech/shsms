<nav class="navbar navbar-light shadow-sm navbar-expand-lg fixed-top bg-white" style="height: 70px;" id="myNavbar">
    ...
    <a class="navbar-brand" href="<?php echo ROOT_URL;?>dashboard.php" style="font-size: 30px; font-weight: 700;">Edukate</a>
    ...
    <div class="collapse navbar-collapse" id="navcol-1">
        ...
        <li class="nav-item dropdown">
                ...
                <img style="width: 30px;
                            height: 30px;
                            border-radius: 50%;" 
                            src="assets/img/user.png" alt="user"> <?php echo substr($_SESSION['fname'],0,1).'. '. $_SESSION['lname'];?>
                </a>
                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                    <li><a class="dropdown-item" href="<?php echo ROOT_URL;?>banks.php">Profile</a></li>
