...
<?php include('inc/navbars/mainNavbar.php')?>
    ...
    <header class="container mt-5 px-5 py-5">
        ...
        data-aos-duration="500" style="font-size:50px;">Events</h1>
        <hr class="container">
    </header>
    ...
    <div class="container py-3 justify-content-center">
            ...
            <div class="table-responsive text-center">
                ...
                <?php if(isset($_SESSION['UserType']) && $_SESSION['UserType'] == 'admin'):?>
                    ...
                    <a data-bs-toggle="modal" data-bs-target="#addEvent" type="button" class="btn btn-primary mx-2">
                    Add New Event
                    </a>
                    <?php endif; ?>
                </div>
                <table  data-toggle="table"
                    ...
                    <?php include 'inc/pages/eventList.php';?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="inc/addforms/addEvent.php">
                        <input type="hidden" name="eid" value="">

                        <div class="row">
                            <div class="form-group col-6">
                                <label for="">Event Name</label>
                                <input class="form-control" placeholder="Enter the name" required="" name="EventName">
                                <br>
                            </div>

                            <div class="form-group col-6">
                                <label for="dob">Event Date</label>
                                <input class="form-control" type="date" required="" name="EventDate">
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="8" required="" name="EventDetails" placeholder="Enter the details"></textarea>
                            <br>
                        </div>

                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <input type="submit" name="addSubmit" class="btn btn-primary" value="Add Event"/>
                        </div>
                    </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="editEvent" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Events Form</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="inc/editforms/editEvent.php">
                        <input type="hidden" value="" name="eid">
                        
                        <div class="row">
                            <div class="form-group col-6">
                                <label for="">Event Name</label>
                                <input class="form-control" placeholder="Enter the name" required="" name="editEventName">
                                <br>
                            </div>

                            <div class="form-group col-6">
                                <label for="dob">Event Date</label>
                                <input class="form-control" type="date" required="" name="editEventDate">
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="">Event Details</label>
                            <textarea class="form-control" rows="8" required="" name="editEventDetails" placeholder="Enter your details"></textarea>
                            <br>
                        </div>
    ...
    <div class="modal fade" id="deleteEvent" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="inc/deleteforms/deleteEvents.php">
