...
<?php include('inc/navbars/mainNavbar.php')?>
    ...
    <div class="container my-5">
        ...
        <div class="card profile-page shadow">
            ...
            <div class="row mx-3 mb-5">
                <div class="col-6">
                <a data-bs-toggle="modal" data-passwordid="<?php echo $_SESSION["id"]; ?>" href="profile.php#editPassword">
                    Change Password?
                </a>
                </div>
                <div class="col-6">
                    <i id="btnReport" class="fa fa-print float-end" data-bs-toggle="tooltip" data-bs-placement="left" rel="tooltip" title="Download Report"></i>
                </div>
            </div>
        </div>
    </div>
 ...
 <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="editProfile" tabindex="-1" aria-hidden="true">
 ...
 <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="editPassword" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="overlay-loading">
                    <div class="d-flex justify-content-center m-5">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="getEditPass">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="editNewPassword" type="password"
                                name="editNewPassword" maxlength="30" required placeholder="Enter the new password"/>
                                <br>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                name="editNewConfirmPassword" maxlength="30" required placeholder="Enter the new password again"/>
                                <br>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <input type="submit" maxlength="30" name="editSubmit" class="btn btn-primary" value="Update Password"/>
                            </div>
                        </form>
                    </div>
                </div>  
