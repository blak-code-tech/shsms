...
<header class="container mt-5 px-5 py-5">
    <h1 class="text-center text-muted" data-aos="zoom-in" data-aos-duration="500" style="font-size:50px;">Exam Results
    </h1>
    <hr class="container">
</header>
...
<!-- Add results Modal -->
<div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="addExamResults" tabindex="-1"
...
<div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="editExamResults" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="overlay-loading">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input class="form-control" required="" id="editScore"
                                    title="Make sure there are 2 digits." type="number" name="editScore"
                                    placeholder="Enter the score out of 100%" />
                                <br>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <input class="form-control" disabled required="" id="editGrade" name="editGrade"
                                    placeholder="Students Grade" />
                                <br>
                            </div>
                        </div>
...
<div class="modal fade" data-bs-backdrop="static" id="deleteExamResults" tabindex="-1"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
